...
![The Data Scientist Life Cycle](images/galaxy_package.jpeg) \## Clash
...
It's also considered rude to make changes to a user's system packages.
...
![fig_x](images/multiple_libraries.png)
...
- Move into the project directory through the cmd line in 2 ways:
  1 Open the .RProj file with RStuduo
...
|-----------------------------------------|-------------------------------|
| List the **three layers of data science environments.**                   | IF YOU CAN FIND A LESS PAINFUL WAY TO DO THIS, DO SO! |
| Explain **why** it's important to **control the package environment.**    | IF YOU CAN FIND A LESS PAINFUL WAY TO DO THIS, DO SO! |
| **Use `{renv}`** (or `{venv}`) to control the **package environment.**    | IF YOU CAN FIND A LESS PAINFUL WAY TO DO THIS, DO SO! |
| Recognize **when** it is important to **control the system environment.** | IF YOU CAN FIND A LESS PAINFUL WAY TO DO THIS, DO SO! |
