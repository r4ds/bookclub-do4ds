...
-   Explain **why** it's important to **control the package
    environment.**
-   **Use `{renv}`** (or `{venv}` and `uv` ) to control the **package
    environment.**
...
- :construction: R in Production [chapter](https://r-in-production.org/packages.html) about packages installation  

- [nix](https://nixos.org/) and [{rix}](https://docs.ropensci.org/rix/) /[guix](https://guix.gnu.org/)
